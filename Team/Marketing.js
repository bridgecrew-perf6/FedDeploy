...
function displayResult3(responseM) {
    mar++;
    if (mar > 1) {} else {
        let k = 1;
            ...
            for (let r = k; r < k + 4; r++) {
                ...
                if (responseM.result.values[r]) {
                    ...
                    <div class="memImgDiv">
                        ...
                        <div class="memlinks">
                            <a href="${responseM.result.values[r][3]}" class="memLink" target="_blank">
                            ...
                            <a href="${responseM.result.values[r][4]}" class="memLink" target="_blank">
